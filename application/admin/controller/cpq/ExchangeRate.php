...
use app\admin\model\cpq\ExchangeRate as ExchangeRateModel;
 ...
 * @icon fa fa-exchange
 */
class ExchangeRate extends Backend
{
    ...
    protected $searchFields = 'source_currency,target_currency,source';
    protected $multiFields = 'status';
    protected $cpqScopeType = null;
    protected $cpqRelations = [];
    protected $cpqFormDefaults = [
        'source_currency' => '', 'target_currency' => '', 'rate' => '', 'source' => 'manual',
    ...
    public function importpreview()
    {
        ...
        try {
            $result = (new ImportPreviewService())->preview('exchange_rate', $rows);
