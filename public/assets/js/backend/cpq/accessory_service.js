define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'backend/cpq/common'], function ($, undefined, Backend, Table, Form, CpqCommon) {
    var Controller = {
        index: function () {
            Table.api.init({extend: {index_url: 'cpq/accessory_service/index' + location.search, add_url: 'cpq/accessory_service/add', edit_url: 'cpq/accessory_service/edit', del_url: 'cpq/accessory_service/del', multi_url: 'cpq/accessory_service/multi', table: 'cpq_accessory_service'}});
            var table = $('#table');
