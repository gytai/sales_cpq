...
use app\admin\model\cpq\Customer as CustomerModel;
...
class Customer extends Backend
{
    ...
    protected $searchFields = 'code,name,name_en,credit_code';
    protected $multiFields = 'status';
    protected $cpqScopeType = null;
    protected $relationSearch = true;
    protected $cpqRelations = ['region', 'customerLevel', 'salesOrg'];
    protected $cpqFormDefaults = [
        'code' => '', 'name' => '', 'name_en' => '', 'type' => 'direct', 'credit_code' => '',
        'country_code' => 'CN', 'region_id' => '', 'customer_level_id' => '', 'agent_id' => '',
        'default_currency' => 'CNY', 'tax_no' => '', 'payment_terms' => '', 'trade_terms' => '',
        'sales_org_id' => '', 'owner_id' => 0, 'status' => 'normal', 'remark' => '',
    ];
    ...
    public function importpreview()
    {
        ...
        try {
            $result = (new ImportPreviewService())->preview('customer', $rows);
