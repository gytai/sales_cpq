...
class CustomerLevel extends Validate
{
    protected $rule = [
        'code' => 'require|regex:^[A-Za-z0-9][A-Za-z0-9_.-]{1,63}$|unique:cpq_customer_level',
    ...
    protected $scene = [
        'add' => ['code', 'name', 'sort', 'default_discount', 'market_scope', 'status'],
        'edit' => ['code', 'name', 'sort', 'default_discount', 'market_scope', 'status'],
    ];
