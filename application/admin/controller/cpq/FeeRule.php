...
use app\admin\model\cpq\FeeRule as FeeRuleModel;
...
class FeeRule extends Backend
{
    ...
    protected $searchFields = 'code,name,fee_type';
    protected $multiFields = 'status';
    protected $cpqScopeType = null;
    protected $cpqRelations = [];
    protected $cpqFormDefaults = [
        'code' => '', 'name' => '', 'fee_type' => '', 'condition_json' => '',
        'calculation_type' => 'fixed', 'value' => '', 'currency' => 'CNY',
        'include_in_margin' => 1, 'include_in_floor' => 1, 'priority' => 0,
    ...
    public function _initialize()
    {
        ...
        $this->view->assign('calculationTypeList', $this->model->getCalculationTypeList());
        $this->assignconfig('statusList', $this->model->getStatusList());
        $this->assignconfig('calculationTypeList', $this->model->getCalculationTypeList());
    }
    ...
    public function importpreview()
    {
        ...
        try {
            $result = (new ImportPreviewService())->preview('fee_rule', $rows);
